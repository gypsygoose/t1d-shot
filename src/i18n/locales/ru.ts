...
export const ru: AppLocale = {
  ...
  menu: {
    ...
    daysToAvailableDialog: {
      message:
        "Через сколько дней после последней отметки точка остаётся недоступной для повторной отметки, независимо от цветового цикла. Не может превышать значение «Дней до восстановления точки». При 0 (по умолчанию) точку можно отметить в любой момент, как и раньше.",
      fieldLabel: "Дней",
    },
    zonePointsDialog: {
      message:
